...
class CIntentExplicitoParametros : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val entrenador = intent.getParcelableExtra<BEentrenador>("entrenador")
        ...
        botonDevolverRespuesta.setOnClickListener {
            ...
            intentDevolverParametros.putExtra("nombreModificado","Mayte")
            intentDevolverParametros.putExtra("edadModificada",23)
            //intentDevolverParametros.putExtra("entrenadorModificado", BEentrenador("Alex","Arevalo"))
            setResult(
                Activity.RESULT_OK, intentDevolverParametros
            )
            finish()
